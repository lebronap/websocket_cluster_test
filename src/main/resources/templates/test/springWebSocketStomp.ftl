...
<head>
    ...
    <script type="text/javascript">
        ...
        function websocketConfig() {
            ...
            var headers = {token:"${session_id}",mobile:"${mobile}"};
        ...
        function sendMsgByMobile() {
             ...
             *  4. accountId这个参数其实可以通过header传过去，不过因为是restful风格，所以就跟在url上
             */
            stompClient.send("/app/sendChatMsgByMobile/" + mobile,{},JSON.stringify(data));
        }
...
<div>
    ...
    <span>接收人手机号</span>
    <input type="text" id="mobileX" name="mobile">
    <input type="button" id="sendMsgByMobile" name="sendMsgByMobile" value="点对点消息mobile" onclick="sendMsgByMobile();">
</div>
</body>
</html>